...
const Header = ({ toggleSidebar }) => {
  ...
  return (
    <header className="bg-gradient-to-r from-gray-900/95 to-gray-800/95 backdrop-blur-xl border-b border-gray-700/50 h-16 flex items-center justify-between px-6 sticky top-0 z-50 shadow-xl">
      {/* Left Section - Menu Button */}
      <button
        onClick={toggleSidebar}
        className="group relative p-2 text-gray-400 hover:text-white transition-all duration-200 hover:bg-gray-700/50 rounded-lg"
      >
      ...
      <div className="flex items-center gap-3">
        ...
        >
          ...
          {/* Tooltip */}
          <span className="absolute -bottom-10 left-1/2 -translate-x-1/2 px-3 py-1.5 bg-gray-800 text-white text-xs rounded-lg opacity-0 group-hover:opacity-100 pointer-events-none transition-opacity whitespace-nowrap shadow-xl z-50">
        ...
        <div className="flex items-center gap-3 pl-3 border-l border-gray-700/50">
          ...
          <div className="relative group cursor-pointer">
            ...
            <div className="relative w-9 h-9 bg-gradient-to-br from-blue-500 to-purple-600 rounded-full flex items-center justify-center text-white font-bold text-sm shadow-lg ring-2 ring-gray-800 group-hover:ring-blue-500/50 transition-all">
          ...
          <button
            ...
            className="group relative p-2 text-gray-400 hover:text-red-400 transition-all duration-200 hover:bg-red-500/10 rounded-lg ml-2"
            title="Logout"
          >
