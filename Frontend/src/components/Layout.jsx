...
function Layout({ children }) {
    // 1. Get the navigate function from React Router
    ...
    const navLinkClasses = "flex items-center space-x-3 p-3 rounded-lg text-gray-700 hover:bg-gray-200";
    const activeNavLinkClasses = "flex items-center space-x-3 p-3 rounded-lg font-bold bg-white text-black shadow-sm";
            ...
            <aside className="w-64 bg-stone-100 p-6 flex flex-col justify-between">
                <div>
                    ...
                    <nav className="space-y-4">
                        ...
                        <NavLink to="/statistics" className={({ isActive }) => isActive ? activeNavLinkClasses : navLinkClasses}>
                            <StatsIcon />
                ...
                <div>
                    ...
                    {/* 3. Make the Logout item a button and attach the onClick handler */}
