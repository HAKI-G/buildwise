...
function DocumentsViewPage() {
    ...
    return (
        <Layout title={`Documents - ${project?.name || 'Project'}`}>
            <div className="space-y-4 sm:space-y-6">
                {/* Project Info Header */}
                <div className="bg-gradient-to-r from-teal-600 to-teal-700 dark:from-teal-700 dark:to-teal-800 rounded-xl p-4 sm:p-6 text-white shadow-lg">
