...
function UpdatesViewPage() {
    ...
    return (
        <Layout title={`Updates - ${project?.name || 'Project'}`}>
            <div className="space-y-4 sm:space-y-6">
                {/* Project Info Header */}
                <div className="bg-gradient-to-r from-green-600 to-green-700 dark:from-green-700 dark:to-green-800 rounded-xl p-4 sm:p-6 text-white shadow-lg">
...
export default UpdatesViewPage;
