...
function PhotosViewPage() {
    ...
    return (
        <Layout title={`Photos - ${project?.name || 'Project'}`}>
            <div className="space-y-4 sm:space-y-6">
                {/* Project Info Header */}
                <div className="bg-gradient-to-r from-purple-600 to-purple-700 dark:from-purple-700 dark:to-purple-800 rounded-xl p-4 sm:p-6 text-white shadow-lg">
